// Code generated by the Encore v1.36.3 client generator. DO NOT EDIT.
...
// Client is an API client for the tractore-e392 Encore application.
type Client struct {
...
func Environment(name string) BaseURL {
	return BaseURL(fmt.Sprintf("https://%s-tractore-e392.encr.app", name))
}
...
func New(target BaseURL, options ...Option) (*Client, error) {
	...
	base := &baseClient{
		...
		userAgent:  "tractore-e392-Generated-Go-Client (Encore/v1.36.3)",
	}
	...
	return &Client{Receiver: &receiverClient{base}}, nil
}
...
type ReceiverIngestRequest struct {
	To   string `json:"to"`
	From string `json:"from"`
	Raw  string `json:"raw"`
}

// ReceiverClient Provides you access to call public and authenticated APIs on receiver. The concrete implementation is receiverClient.
// It is setup as an interface allowing you to use GoMock to create mock implementations during tests.
type ReceiverClient interface {
	Ingest(ctx context.Context, params ReceiverIngestRequest) error
}
...
var _ ReceiverClient = (*receiverClient)(nil)

func (c *receiverClient) Ingest(ctx context.Context, params ReceiverIngestRequest) error {
	_, err := callAPI(ctx, c.base, "POST", "/receiver.Ingest", nil, params, nil)
	return err
}
